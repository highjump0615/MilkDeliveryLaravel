...
$('#customer_form').on("submit", function (e) {
    ...
    $.ajax({
        type: "POST",
        url: API_URL + "naizhan/dingdan/dingdanxiugai/change_customer",
        data: customer_data,
        success: function (data) {
            ...
            if (data.status == 'success') {
                ...
                //location.reload();
                // var url = SITE_URL+"naizhan/dingdan/daishenhe";
...
$('#order_form').on('submit', function(e){
    ...
    $.ajax({
        type: "POST",
        url: API_URL + "naizhan/dingdan/dingdanxiugai/change_order_info",
        data: sendData,
        success: function (data) {
            console.log(data);
            $('#order_spinner').hide();
