...
$('#search').click(function () {
    ...
    window.location.href = SITE_URL+"zongpingtai/tongji/kehuxingwei?station_name="+station_name+"&station_number="+station_number+
        "&province="+province+"&city="+city+"&start_date="+start_date+"&end_date="+end_date+"";
});

$('button[data-action = "print"]').click(function () {
    printContent('table1', gnUserTypeAdmin, '客户行为分析');
});
