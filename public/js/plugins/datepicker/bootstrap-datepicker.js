...
(function ($, undefined) {
    ...
    Datepicker.prototype = {
        ...
        setBValue: function () {
            ...
            var formatted = this.getFormattedBDate();
        ...
        getFormattedBDate: function (format) {
            if (format === undefined)
                format = this.o.format;
            ...
            for( var i = 0; i< length; i++)
            {
                ...
                if(i==length-1)
                    ...
                    result += one+this.o.multidateSeparator;
            }
            return result;
        },
        ...
        change: function (e) {
            ...
            if (target.length === 1) {
                var tt = target[0];
                if (tt.className.indexOf("tip-input") == 0) {
                    tt.focus();
                    var b = $(tt).val();
                        ...
                        case 'td':
                            if (target.is('.day') && !target.is('.disabled') && !this.o.class.toString().includes('only_show')) {
                                ...
                                if (this.o.showNum && ( $(tt).children('.tip-input').length == 0 )) {
                                    ...
                                    tip_input.remove();
                                    this._setBDate('-1', UTCDate(year, month, day));
                                } else {
                                    this._setDate(UTCDate(year, month, day));
                                }
                            }
        ...
        _toggle_bmultidate: function (date, b) {
            if(b == undefined)
                b=3;
            var ix = this.dates.contains(date);
            if (!date) {
                ...
                this.dates.remove(ix);
                this.bottles.remove(ix);
            }
            else {
                this.dates.push(date);
                this.bottles.push(new bottle(date, b));
            }
            if (typeof this.o.multidate === 'number')
                while (this.dates.length > this.o.multidate)
                    this.dates.remove(0);
        ...
        keydown: function (e) {
            ...
            switch (e.keyCode) {
                ...
                case 13: // enter
                    ...
                    this._toggle_bmultidate(focusDate);
