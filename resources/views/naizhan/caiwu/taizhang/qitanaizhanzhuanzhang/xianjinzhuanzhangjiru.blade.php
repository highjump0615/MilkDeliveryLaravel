    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row border-bottom">
            <ol class="breadcrumb gray-bg" style="padding:5px 0 5px 50px;">
                ...
                <li class="active">
                    <a href="{{ url('/naizhantaizhang/zhanghuyue') }}"><strong>其他奶站现金转账记录</strong></a>
                </li>
            </ol>
        </div>
        ...
        <div class="row">
            <div class="ibox-content white-bg">
                ...
                <div class="col-md-5">
                    <div class="col-md-6">
                        <a href="{{URL::to('/naizhan/caiwu/taizhang/qitanaizhanzhuanzhang/zhuanzhangjiru')}}" class="btn
                           btn-outline btn-success" type="button" style="width:100%;">查看已转账记录</a>
                    </div>
                    <div class="col-md-6">
                        <a href="{{URL::to('/naizhan/caiwu/taizhang/qitanaizhanzhuanzhang/zhuanzhangzhangdan')}}"
                           class="btn
