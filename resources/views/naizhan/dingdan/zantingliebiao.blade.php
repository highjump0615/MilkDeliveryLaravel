            ...
            <div class="wrapper-content">
                ...
                <div class="feed-element">
                    <div class="vertical-align">
                        ...
                        <div class="col-md-2">
                            <select data-placeholder="" id="filter_payment_type"
                ...
                <div class="feed-element">
                    <div class="feed-element form-group" id="data_range_select">
                        ...
                        <div class="input-daterange input-group col-md-3" id="datepicker">
                            <input type="text" id="filter_order_start_date" class="input-sm form-control"
                                   name="start"/>
                            <span class="input-group-addon">至</span>
                            <input type="text" id="filter_order_end_date" class="input-sm form-control"
                                   name="end"/>
                        </div>
                    </div>
                </div>
