		...
		<div class="row">
			<div class="ibox float-e-margins">
				<div class="ibox-content" style="border: 1px solid #10ee00;">
					<form class="form-horizontal" method="post" action="{{url('/gongchang/login')}}">
						{{ csrf_field() }}
						<br>
						<div class="form-group">
							<label class="col-xs-3 control-label" style="font-size: 17px;">用户名:</label>
							<div class="col-xs-9"><input type="text" name="name" class="form-control"  value="{{ old('name') }}">
								{{--@if ($errors->has('name'))--}}
						...
						<div class="form-group"><label class="col-xs-3 control-label" style="font-size: 17px;">密 码:</label>
							<div class="col-xs-9"><input type="password" name="password" class="form-control"></div>
