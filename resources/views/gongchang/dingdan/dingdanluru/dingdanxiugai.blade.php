            ...
            <form method="POST" enctype="multipart/form-data" id="customer_form">
                ...
                <div class="feed-element col-md-12">
                    ...
                    <div class="col-md-10" style="padding-left: 0px;">
                        <div class="col-md-2">
                            <input required readonly id="province" name="c_province" value="{{$customer->province}}"
                                   class=" form-control"/>
                        </div>
                        <div class="col-md-2">
                            <input required readonly id="city" name="c_city" value="{{$customer->city}}"
                                   class="form-control"/>
                        </div>
                        <div class="col-md-2">
                            <select data-origin="{{$customer->district}}" required id="district" name="c_district"
                                    class="district_list form-control addr_info">
                            </select>
                        </div>
                        <div class="col-md-3">
                            <select data-origin="{{$customer->street}}" required id="street" name="c_street"
                                    class="street_list form-control addr_info">
                            </select>
                        </div>
                        <div class="col-md-3">
                            <select data-origin="{{$customer->xiaoqu}}" id="xiaoqu" required name="c_xiaoqu"
                ...
                <div class="feed-element col-md-12">
                    <div class="col-md-3 col-md-offset-2">
                        <input type="text" placeholder="填写详细地址" id="sub_addr" name="c_sub_addr"
                               ...
                               class="form-control addr_info" value="{{$customer->sub_addr}}">
                    </div>
                </div>
                <div class="feed-element col-md-12">
                ...
                <div class="feed-element col-md-12">
                    @if($order->receipt_path)
                        ...
                        <div class="col-md-6 col-md-offset-2" id="change_ticket_div" style="display:none;">
                            ...
                            <input required type="hidden" name="receipt_path" id="receipt_path" value="{{$order->receipt_path}}"/>
                ...
                <div class="feed-element col-md-12">
                    <div class="feed-element col-md-12">
                        ...
                        <div class="col-md-6 col-md-offset-4">
                            ...
                            <label class="col-md-4">当前订单金额: <span class="current_total_sp">{{$order->remain_order_money}}</span></label>
                            <label class="col-md-4">更改订单金额: <span class="updated_total_sp">{{$order->remain_order_money}}</span></label>
                        </div>
                    </div>
                    <div class="feed-element col-md-12">
...
@section('script')
    ...
    <script language="JavaScript">
        ...
        var customer_province = "{{$customer->province}}";
    ...
    <script src="<?= asset('/js/pages/gongchang/order_xiugai.js')?>"></script>
@endsection