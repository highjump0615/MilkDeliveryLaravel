...
@section('content')
    ...
    <div id="page-wrapper" class="white-bg">
        ...
        <div class="row">
                    ...
                    <div class="feed-element col-md-12">
                        <div class="col-md-3 col-md-offset-2">
                            <input type="text" placeholder="填写详细地址" id="sub_addr" name="c_sub_addr"
                                   class="form-control" value="{{$customer->sub_addr}}">
                        </div>
                    </div>
                    <div class="feed-element col-md-12">
            ...
            <form method="POST" enctype="multipart/form-data" id="order_xudan_form">
                <div id="station_info">
                    ...
                    <div class="feed-element col-md-12">
                        ...
                        <div class="col-md-3">
                            <select required class="form-control" id="station_list" name="station">
                                @if($order->station_name && $order->station_id)
                            ...
                            <select required class="form-control" id="order_checker_list" name="order_checker">
                                @if (isset($order_checkers))
                                    @foreach ($order_checkers as $orderchecker)
                                        @if (isset($order->order_checker_id) && $order->order_checker_id == $orderchecker->id)
                                            <option value="{{$orderchecker->id}}"
                                                    selected>{{$orderchecker->name}}</option>
                                        @else
                    ...
                    <input type="hidden" required name="customer_id" value="{{$customer->id}}" id="customer_id"/>
                </div>
                ...
                <div id="order_info">
                    ...
                    <div class="feed-element col-md-12">
                        ...
                        <div class="col-md-3">
                            <input class="js-switch js-check-change" type="checkbox" id="milk_box_install" name="milk_box_install"/>
                        </div>
                    </div>
                    <div class="feed-element col-md-12">
                        ...
                        <div class="col-md-2">
                            <input id="milk_card_check" class="js-switch js-check-change" type="checkbox" data-toggle="modal" data-target="#card_info"/>
                        </div>
                    ...
                    <div class="feed-element col-md-12">
                        ...
                        <div class="col-md-2">
                            <select required class="form-control" id="delivery_noon" name="delivery_noon">
                                @if(isset($order->delivery_time) && $order->delivery_time == 1)
                                            ...
                                            <td class="col-sm-1">
                                                ...
                                                <div class="col-sm-7">
                                                    <input required name="one_product_total_count[]"
                                                           ...
                                                           type="number" min="30" value = "{{$op->total_count}}"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-lg-3 col-md-4 statics">
                            <div>
                                ...
                                <div class="col-md-5">
                                    <input required readonly id="total_amount" name="total_amount" value="{{$order->total_amount}}"/>
                                </div>
                            </div>
                            <div>
                                <label for="remaining" class="control-label col-md-7">账户余额：</label>
                                <div class="col-md-5">
                                    <input required readonly id="remaining" name="remaining"
                                           value="{{$remain_amount}}"/>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="col-md-5">
                                    <input required readonly id="acceptable_amount" name="acceptable_amount"
                                           value="{{$order->total_amount - $remain_amount}}"/>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    ...
    <script language="JavaScript">
        ...
        var customer_province = "{{$customer->province_name}}";
        var customer_city = "{{$customer->city}}";
        var customer_district = "{{$customer->district}}";
        var customer_street = "{{$customer->street}}";
        var customer_xiaoqu = "{{$customer->xiaoqu}}";
    ...
    <script src="<?=asset('js/pages/gongchang/order_xudan.js') ?>"></script>
@endsection