            ...
            <div class="wrapper-content">
                ...
                <div class="feed-element">
                    ...
                    <div class="col-md-2 col-md-offset-6">
                        ...
                        <button class="btn btn-success" type="button" data-action="show_selected_on_quanbu">筛选</button>
                    </div>
                </div>
...
@section('script')
    <script type="text/javascript">
        var at_page = "quanbu";
        //Filter Function
        $('button[data-action="show_selected_on_quanbu"]').click(function () {
            ...
            $(order_table).find('tbody tr').each(function () {
                ...
                if ( (tr.attr("data-show-1") == "1" ) && (tr.attr("data-show-2") == "1")
                        && (tr.attr("data-show-3") == "1") && (tr.attr("data-show-4") == "1" )
                        && (tr.attr("data-show-5") == "1" ) && (tr.attr("data-show-6") == "1" )
                        && (tr.attr("data-show-7") == "1" ) && (tr.attr("data-show-8") == "1" )
                        && (tr.attr("data-show-9") == "1" ) && (tr.attr("data-show-10") == "1" ) )
                {
