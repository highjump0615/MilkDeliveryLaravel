...
<!--Table-->				
				...
				<div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <table id="customerTable" class="footable table table-bordered" data-page-size="15">
                            <thead>
								<tr>
						...
						<table id="filteredTable" class="footable table table-bordered" data-page-size="15" style="display: none">
							<thead>
							<tr>
								<th data-sort-ignore="true">序号</th>
								<th data-sort-ignore="true">区域</th>
